    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerText}>대표자명 : 류정윤 | 사업자등록번호 : 287-18-02366</Text>
          <Text style={styles.footerText}>주소 : 서울특별시 서대문구 성산로17길 19, 401호(연희동)</Text>
          <Text style={styles.footerText}>
            전화번호: {formatPhoneNumber(auth.phoneNumber || "01089756124")} | 이메일: chaltteoks2@gmail.com
          </Text>
          <Text style={styles.footerText}>
